          ...
          <div className="mt-16 space-y-10 md:mt-24 md:space-y-14">
            {blogPosts.map((p) => (
              <Link
                ...
                id={p.slug}
                key={p.slug}
                className="group grid scroll-mt-24 gap-6 border-b border-plynos-navy/10 pb-10 last:border-b-0 last:pb-0 md:grid-cols-[1fr,1.4fr] md:gap-10 md:pb-14"
              >
                <div className="relative aspect-square w-full overflow-hidden rounded-2xl border border-plynos-navy/10">
                  <Image
                    src={p.image}
                    alt=""
                    width={500}
